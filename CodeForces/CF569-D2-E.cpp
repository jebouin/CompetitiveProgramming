 ...
 *
 *  Idea:
 *          - Every word not lexicographically smaller than the given word can be obtained by choosing a prefix
 *            of length p, a bigger letter for position p + 1 and any suffix after this position.
 *          - Consider every prefix from longest to shortest. Try to greedily choose the letters and use 2-SAT 
 *            to check that it's still possible to form the word with given constraints.
 *          - Don't forget the case where the language is only vowels or consonants.
 */
